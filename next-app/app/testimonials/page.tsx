...
const TESTIMONIALS_LIST = [
  {
    id: 1,
    name: "Shalini Sharma",
    role: "Mother of Aarav (Nursery student)",
    quote: "My child Aarav was very shy and refused to interact. After just 3 months at My Wings Academy, he started humming school rhymes, sorting toys independently, and looking forward to school every single morning! The CCTV security access gives me peace of mind throughout the day.",
    rating: 5,
    initial: "S",
    color: "yellow",
  },
  {
    id: 2,
    name: "Dr. Vikram Seth",
    role: "Father of Meera (Playgroup student)",
    quote: "We were extremely anxious about sending Meera to preschool at 18 months. But the teachers here are so trained in pediatric care and emotional bonding. They share regular updates and make sure safety protocols are met meticulously. Highly recommended!",
    rating: 5,
    initial: "V",
    color: "blue",
  },
  {
    ...
    role: "Parents of Kabir (Junior KG student)",
    quote: "The play-based curriculum here is superb. Kabir has developed amazing language capabilities and logical thinking. He is constantly asking curious questions and exploring puzzles. The school feels like a premium educational branding agency built it.",
    rating: 5,
    initial: "R",
    color: "green",
  },
  {
    ...
    role: "Mother of Ishaan (Senior KG student)",
    quote: "Ishaan is preparing to graduate next month, and the primary school interview coordinators were highly impressed by his read readiness and social confidence. The Senior KG syllabus is perfectly structures to build real child outcomes.",
    rating: 5,
    initial: "A",
    color: "red",
  },
